...
void handleAction(BuildContext context, AircraftAction action) {
  ...
  switch (action) {
    ...
    case AircraftAction.share:
      ...
      break;
    case AircraftAction.arifursave:
      context
          .read<AircraftCubit>()
          .exportPackToMariaDB(mac: messagePackList.last.macAddress,
          Lat :messagePackList.last.locationMessage?.latitude,
          Lon :messagePackList.last.locationMessage?.longitude,
          altitude :messagePackList.last.locationMessage?.altitudePressure,
          height :messagePackList.last.locationMessage?.height, save: false)
          .then(
            (value) {
